    ...
    <li className="rounded-md border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-3 text-sm space-y-2">
      ...
      {flag.status === 'open' && (
        <button
          ...
          className="rounded-md bg-[#111111] dark:bg-white text-white dark:text-slate-900 px-3 py-1.5 text-xs font-medium disabled:opacity-50"
        >
          Acknowledge
        </button>
      )}
          ...
          {!showResolveForm ? (
            ...
            <div className="w-full space-y-1">
              ...
              <button
                ...
                className="rounded-md bg-[#111111] dark:bg-white text-white dark:text-slate-900 px-3 py-1.5 text-xs font-medium"
              >
                Confirm resolve
              </button>
